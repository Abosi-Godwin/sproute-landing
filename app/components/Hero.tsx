...
const notifications = [
    {
        ...
        sub: "TopView Hotel, Asaba · Score 10/10"
    },
    {
        icon: "✅",
        title: "Client replied",
        sub: 'Doro Shawarma · "Sounds interesting"'
    },
    {
        icon: "⚡",
        title: "AI message ready",
        sub: "Ella's Store, Lagos · Curiosity angle"
    },
    {
        icon: "📅",
        title: "Meeting booked",
        sub: "Avenue Restaurant, Enugu · Wednesday"
    }
];
...
function FloatingNotification() {
    ...
    return (
        <div
            ...
            className="absolute bottom-6 left-4 bg-base-900 border border-base-700/60 rounded-2xl px-4 py-3 flex items-center gap-3 shadow-xl shadow-base-950/60 z-10 max-w-[220px]"
        >
            <span className="text-xl shrink-0">{n.icon}</span>
            <div>
                <p className="text-base-100 text-xs font-medium leading-none">
                    {n.title}
                </p>
                <p className="text-base-500 text-[10px] mt-1 leading-snug">
                    {n.sub}
                </p>
            </div>
            <div className="ml-auto w-2 h-2 rounded-full bg-brand-500 animate-pulse shrink-0" />
        </div>
    );
}
            ...
            <div className="relative bg-base-900 border border-base-700/60 rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="grid grid-cols-3 gap-px bg-base-800 border-b border-base-800">
                    {[
                        ...
                        <div
                            key={s.label}
                            className="bg-base-900 px-3 py-2.5 text-center"
                        >
                ...
                <div className="mx-3 mb-3 p-3 bg-brand-500/10 border border-brand-500/20 rounded-xl flex items-start gap-2">
                    ...
                    <p className="text-xs text-base-300 leading-relaxed">
                        ...
                        &mdash; &ldquo;Hey TopView, noticed your listing could
                        use a website&hellip;&rdquo;
                    </p>
                </div>
            </div>
...
const taglines = ["Land clients.", "Win deals.", "Close fast.", "Get paid."];
        ...
        <section className="relative min-h-screen flex items-center pt-16 pb-24 overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center w-full">
                ...
                <div>
                    ...
                    >
                        Sproute helps freelancers discover local businesses on
                        Google Maps, score which ones are worth contacting, and
                        generate personalised WhatsApp messages that actually
                        get replies.
                    </p>
                    ...
                    {/* star rating — Expenx style */}
                    <div
                        className="flex items-center gap-3 mb-4"
                        style={{ animation: "fadeUp 0.7s ease 0.62s both" }}
                    >
                        ...
                        <span className="text-base-600 text-xs">
                            from real WhatsApp conversations
                        </span>
                    </div>

                    <p
                        className="text-base-600 text-xs flex items-center gap-1.5"
                        style={{ animation: "fadeUp 0.7s ease 0.68s both" }}
                    >
            ...
            >
                <p className="text-base-600 text-xs flex items-center justify-center gap-2">
                    ...
                    Used by freelancers closing real clients in Asaba, Lagos and
                    Enugu
                    <Star size={11} className="text-brand-500 fill-brand-500" />
                </p>
            </div>
